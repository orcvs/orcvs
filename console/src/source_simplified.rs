...
pub struct SimplifiedSource {
    pub glyphs: Vec<Glyph>,
    pub src: Vec<String>,
    // pub glyphs: ArrayVec<Glyph, 40000>,
    // pub src: ArrayVec<String, 40000>,
    cols: usize,
    rows: usize,
}
...
impl SimplifiedSource {
    pub fn new(cols: usize, rows: usize) -> Self {
        ...
        // let mut glyphs = ArrayVec::<Glyph, 40000>::new();
        // let mut src = ArrayVec::<String, 40000>::new();

        // for _ in 0..40000 {
        //     glyphs.push(Glyph::default());
        //     src.push(TERMINATOR.to_string());
        // }
    ...
    pub fn parse(&mut self, idx: usize) {
        let mut exp = ArrayVec::<String, 64>::new();
...
#[cfg(test)]
mod test {
    use crate::source_simplified::is_terminator;
    use crate::source_simplified::is_terminator_bytes;
    use crate::source_simplified::Glyph;
    use crate::source_simplified::SimplifiedSource;
    use crate::source_simplified::Terminator;
    use crate::source_simplified::G;
    ...
    fn test_get_glyph_at_with_edit() {
        ...
        let mut source = SimplifiedSource::new(10, 1);
    ...
    fn test_get_at() {
        ...
        let source = SimplifiedSource::from_source(10, 1, "T......X..");
    ...
    fn test_source_() {
        let _source = SimplifiedSource::from_source(10, 10, "..........");
    }
    ...
    fn test_to_idx() {
        ...
        let source = SimplifiedSource::new(10, 10);
    ...
    fn source_from(s: &str) -> SimplifiedSource {
        let mut source = SimplifiedSource::new(10, 1);
