...
use egui::{
    Color32, CursorIcon, Event, EventFilter, FontId, Key, PointerButton, Pos2, Rect, Sense, Vec2,
    emath::TSTransform,
};
...
use self::glyphs::GLYPH_SCALE_STEP;
use self::shapes::{effect_outline, show_source};
use crate::config::Config;
use crate::cursor_effects::{
    CursorEffectAnimation, CursorEffectSample, CursorEffectSettings, effect_bounds,
};
