...
Status: accepted. Amends [ADR 0045](0045-the-source-view-is-a-bounded-space.md): the default Grid, the default window and the Pan bounds change; Zoom, the Pan gestures and the Cursor follow stand.
