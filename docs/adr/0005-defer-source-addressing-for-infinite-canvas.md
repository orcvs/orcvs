...
Status: superseded by [ADR 0049](0049-a-position-is-two-numbers.md), which fixes a 256 by 256 limit and spells a Position as two Numbers. The `&` prefix and the four directional Address Functions stand.
