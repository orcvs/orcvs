...
- [ ] A highlight Cell is a highlight, and a space Cell is a space; neither is a marker.
- [ ] An empty Source shows markers only where the marker spacing puts them, with plain space between.
- [ ] Tests distinguishing the three kinds fail if any two are made equal again.
