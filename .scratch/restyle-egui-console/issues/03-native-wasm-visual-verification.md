...
**Blocked by:** 01 — Square, centred Source Grid viewport; 02 — Prototype-aligned console palette; v1-release/03 — Run the exact-candidate verification workflow.
...
- [ ] Each artifact records SHA, OS or browser, viewport dimensions, capture procedure, date, and
      reviewer.
- [ ] The checklist verifies square Cell geometry, centred wide/tall presentation, the decided
