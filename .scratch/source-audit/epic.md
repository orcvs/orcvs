...
| [x] | 8 ([#153](https://github.com/orcvs/orcvs/pull/153)) | Cache dependency schedules | [#19](issues/19-cache-the-tick-schedule-per-language-map-revision.md) | Prefer after PR 6; reconcile #19’s hard blocker with the selected cache-key design. Cover identical-write reuse and invalidation against fresh planning. |
