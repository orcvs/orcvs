...
`docs/adr/0006`–`0019` now define, so the documented sources of truth and the shipped parser
agree.

## Why

The Orca operator audit settled the Orcvs Function vocabulary in `CONTEXT.md` and ADRs 0006–0019,
