...
**What to build:** General arithmetic wraps modulo 256 across the full `00`–`FF` Number range
instead of saturating, and division by zero diagnoses instead of returning zero, as ADR 0011
requires.
