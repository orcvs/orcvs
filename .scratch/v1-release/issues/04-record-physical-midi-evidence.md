...
- [ ] Change the destination mid-run on the physical device and record whether playback continued
      without an audible gap or an Overrun diagnostic (`midi-port-ownership/08`).
