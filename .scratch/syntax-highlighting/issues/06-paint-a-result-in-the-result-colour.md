...
**2026-09-20.** `12` fits a Sequence-capable root's highlight to its answer: at least four Cells from the Output Portal, then each following written Cell pair, clipped to the Reservation. The Sequence case above is amended to match. Nothing about the scalar, Bang, Terminal Output, Halt, Source-writing, empty-Portal or precedence cases changes.
