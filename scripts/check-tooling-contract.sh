...
assert_toml_task_contains "$root_dir/mise.toml" 'test_persistence' '^cargo clippy --package console --all-targets --features persistence --locked -- -D warnings$'
assert_toml_task_contains "$root_dir/mise.toml" 'test_persistence' '^cargo nextest run --package console --all-targets --features persistence --profile ci --locked$'
assert_toml_task_contains "$root_dir/mise.toml" 'test_persistence' '^cargo test --package console --doc --features persistence --locked$'
assert_toml_task_contains "$root_dir/mise.toml" 'test_persistence' '^RUSTDOCFLAGS="-D warnings" cargo doc --package console --no-deps --features persistence --locked$'
